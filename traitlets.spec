...
Source0  : https://files.pythonhosted.org/packages/d5/bc/37d490908e7ac949614d62767db3c86f37bc5adb6129d378c35859a75b87/traitlets-5.1.0.tar.gz
...
%prep
%setup -q -n traitlets-5.1.0
cd %{_builddir}/traitlets-5.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631216692
...
cp %{_builddir}/traitlets-5.1.0/COPYING.md %{buildroot}/usr/share/package-licenses/traitlets/42f5ceb01d59f395d5376b6a6e2af3a99ea0873f
