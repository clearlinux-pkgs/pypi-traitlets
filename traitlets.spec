...
Source0  : https://files.pythonhosted.org/packages/5e/3a/f510eeb8388cf4028c690faec22843176772f5e59c8d418e8268d71ebd7a/traitlets-5.0.4.tar.gz
...
%prep
%setup -q -n traitlets-5.0.4
cd %{_builddir}/traitlets-5.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599610310
...
cp %{_builddir}/traitlets-5.0.4/COPYING.md %{buildroot}/usr/share/package-licenses/traitlets/42f5ceb01d59f395d5376b6a6e2af3a99ea0873f
