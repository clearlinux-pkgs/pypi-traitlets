...
Source0  : https://files.pythonhosted.org/packages/0b/c2/bb2b6eec33cdccfe16415a979aca248628478e6ac80759e5fbf1cb82d0aa/traitlets-5.2.2.post1.tar.gz
...
%prep
%setup -q -n traitlets-5.2.2.post1
cd %{_builddir}/traitlets-5.2.2.post1
pushd ..
cp -a traitlets-5.2.2.post1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656367333
...
cp %{_builddir}/traitlets-5.2.2.post1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-traitlets/2c15eff35efcbd62ef860412b46613a6a194fbc3
