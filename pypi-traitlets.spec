...
Source0  : https://files.pythonhosted.org/packages/39/c3/205e88f02959712b62008502952707313640369144a7fded4cbc61f48321/traitlets-5.9.0.tar.gz
...
%prep
%setup -q -n traitlets-5.9.0
cd %{_builddir}/traitlets-5.9.0
pushd ..
cp -a traitlets-5.9.0 buildavx2
popd
