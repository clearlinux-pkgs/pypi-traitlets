...
Source0  : https://files.pythonhosted.org/packages/a2/4d/1f59a77fba6e8e9feea7a168652030564089d66c06492ba5670e73b0e078/traitlets-5.4.0.tar.gz
...
%prep
%setup -q -n traitlets-5.4.0
cd %{_builddir}/traitlets-5.4.0
pushd ..
cp -a traitlets-5.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662998716
...
cp %{_builddir}/traitlets-%{version}/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-traitlets/2c15eff35efcbd62ef860412b46613a6a194fbc3 || :
