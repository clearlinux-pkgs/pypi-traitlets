...
Source0  : https://files.pythonhosted.org/packages/4f/97/d957b3a5f6da825cbbb6a02e584bcab769ea2c2a9ad67a9cc25b4bbafb30/traitlets-5.14.2.tar.gz
...
%prep
%setup -q -n traitlets-5.14.2
cd %{_builddir}/traitlets-5.14.2
pushd ..
cp -a traitlets-5.14.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710255247
