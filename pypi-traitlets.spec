...
Source0  : https://files.pythonhosted.org/packages/be/58/2d930cfab2caca22c827229ca61aabd8102423f7e817805cba706dce1598/traitlets-5.8.1.tar.gz
...
%prep
%setup -q -n traitlets-5.8.1
cd %{_builddir}/traitlets-5.8.1
pushd ..
cp -a traitlets-5.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673283676
