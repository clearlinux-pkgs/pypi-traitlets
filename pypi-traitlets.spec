...
Source0  : https://files.pythonhosted.org/packages/ed/98/43976cc847e7f2a79770af0a92cbb3cbf0e568ba0b3daa88699b4c746ae9/traitlets-5.6.0.tar.gz
...
%prep
%setup -q -n traitlets-5.6.0
cd %{_builddir}/traitlets-5.6.0
pushd ..
cp -a traitlets-5.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669825557
