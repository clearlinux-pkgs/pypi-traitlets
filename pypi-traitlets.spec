...
Source0  : https://files.pythonhosted.org/packages/9b/26/5e5f9002f939d54663d244a260d0453b2baf4f767697da5968aa474f04e7/traitlets-5.2.1.post0.tar.gz
...
%prep
%setup -q -n traitlets-5.2.1.post0
cd %{_builddir}/traitlets-5.2.1.post0
pushd ..
cp -a traitlets-5.2.1.post0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653429622
...
cp %{_builddir}/traitlets-5.2.1.post0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-traitlets/2c15eff35efcbd62ef860412b46613a6a194fbc3
