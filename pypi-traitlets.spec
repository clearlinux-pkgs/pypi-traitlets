...
Source0  : https://files.pythonhosted.org/packages/0b/db/9adbbb2bef9a43ecfa4f1cbcec1d662adade10262328a4b7ef65effc6341/traitlets-5.7.1.tar.gz
...
%prep
%setup -q -n traitlets-5.7.1
cd %{_builddir}/traitlets-5.7.1
pushd ..
cp -a traitlets-5.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670885002
